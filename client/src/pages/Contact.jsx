    ...
    async (data) => {
      try {
        const response = await fetch(
          `${import.meta.env.VITE_REACT_APP_BASEURL}/api/form/contact`,
          {
            method: "POST",
    ...
    <div className="min-h-screen bg-slate-800 px-44">
      <section className="h-full mt-10">
        <main className="p-3 w-full">
          <span className="text-4xl font-semibold mr-60 border-b-4 border-blue-500 mb-7">
            Contact Us
          </span>
          <div className="flex gap-32 w-full mt-10">
            ...
            <div className="right-side w-1/2 h-full">
              <form
                ...
                className="flex flex-col mt-16 items-center w-full px-16"
              >
